...
<table align="center" style="margin: 0px auto;">
    ...
    <tr>
        ...
        <td style="text-align: center; vertical-align: middle;">Rough sounding attractive teenage girl with a voice suited for client and public interaction.</td>
    </tr>
    <tr>
        <td><audio controls style="width: 180px; height: 50px;"><source src="dreamvc/9_Rough sounding attractive teenage girl with a voice suited for client and public interaction..wav" type="audio/wav"></audio></td>
        <td><audio controls style="width: 180px; height: 50px;"><source src="dreamvg/9_Rough sounding attractive teenage girl with a voice suited for client and public interaction..wav" type="audio/wav"></audio></td>
        <td><audio controls style="width: 180px; height: 50px;"><source src="dreamvg/9_Rough sounding attractive teenage girl with a voice suited for client and public interaction._freevc.wav" type="audio/wav"></audio></td>
    </tr>
